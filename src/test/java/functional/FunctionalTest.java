...
public class FunctionalTest {
	...
	String filePath = "src/main/java/com/yaksha/assignment/EncapsulationAbstractClassAssignment.java";
	...
	public void testMethodOperationsOnly() throws Exception {
		...
		boolean result = autoGrader.testEncapsulationAndAbstractClassMethods(filePath);
